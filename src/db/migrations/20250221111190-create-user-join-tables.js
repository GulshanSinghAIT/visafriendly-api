...
module.exports = {
  async up(queryInterface, Sequelize) {
    // Creating association tables for many-to-many relationships
    await queryInterface.createTable("UserEducation", {
      userId: {
    ...
    await queryInterface.createTable("UserJobType", {
      userId: {
        type: Sequelize.INTEGER,
        allowNull: false,
        references: {
  ...
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.dropTable("UserJobType");
    await queryInterface.dropTable("UserEducation");
  },
}; 